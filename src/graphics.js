const Graphics = {
    ...
    drawStatsTate() {
        ...
        Graphics.printIntRight(Graphics.displayContext, System.hi, 216, 8, 0);

        Graphics.printString(Graphics.displayContext, '@2024', 44, 248, 0);
        Graphics.printString(Graphics.displayContext, 'Red Balltop', 92, 248, 1);
    },
    drawStatsYoko() {
        ...
        Graphics.printIntRight(Graphics.displayContext, System.hi, 304, 48, 0);

        Graphics.printString(Graphics.displayContext, '@2024', 232, 192, 0);
        Graphics.printString(Graphics.displayContext, 'Red', 280, 192, 1);
        Graphics.printString(Graphics.displayContext, 'Balltop', 232, 200, 1);
    },
    clear() {
        // Clear Play Area
