const Graphics = {
    ...
    drawStatsTate() {
        ...
        this.printIntRight(this.preRenderContext, System.hi, 216, 8, 0);

        this.printString(this.preRenderContext, '@2024', 44, 248, 0);
        this.printString(this.preRenderContext, 'Red Balltop', 92, 248, 1);
    },
    drawStatsYoko() {
        ...
        this.printIntRight(this.preRenderContext, System.hi, 304, 48, 0);

        this.printString(this.preRenderContext, '@2024', 232, 192, 0);
        this.printString(this.preRenderContext, 'Red', 280, 192, 1);
        this.printString(this.preRenderContext, 'Balltop', 232, 200, 1);
    },
    clear() {
        // Clear Play Area
